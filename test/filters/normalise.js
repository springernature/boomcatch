...
modulePath = '../../src/filters/normalise';
...
suite('filters/normalise:', function () {
    ...
    suite('require:', function () {
        ...
        test('initialise function is exported', function () {
            assert.isFunction(normalise.initialise);
        });

        test('initialise does not throw', function () {
            assert.doesNotThrow(function () {
                normalise.initialise();
            });
        });
        ...
        suite('call initialise:', function () {
            ...
            test('filter throws without data', function () {
                assert.throws(function () {
                    filter();
                });
            });

            test('filter does not throw with data', function () {
                assert.doesNotThrow(function () {
                    filter({});
                });
            });

            suite('call filter with bad data:', function () {
                var result;
            ...
            suite('call filter with round-trip data:', function () {
                var result;
            ...
            suite('call filter with navigation-timing data:', function () {
                var result;
            ...
            suite('call filter with resource-timing data:', function () {
                var result;
            ...
            suite('call filter with reduced resource-timing data:', function () {
                var result;
            ...
            suite('call filter with reduced round-trip data:', function () {
                var result;
